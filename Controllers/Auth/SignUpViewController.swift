...
class SignUpViewController: UITabBarController {
    ...
    override func viewDidLoad() {
        ...
        signUpButton.addTarget(self, action: #selector(getter: signUpButton), for: .touchUpInside)
    }
    override func viewDidLayoutSubviews() {
        ...
        signUpButton.frame = CGRect(x: 20, y: passwordField.bottom+30, width: view.width-40, height: 50)
    }
